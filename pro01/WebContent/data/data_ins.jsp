		...
		<div style="width:1400px; margin:0 auto;">
			<nav aria-label="breadcrumb d-flex justify-content-between">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item active" aria-current="page">자료 등록</li>
			  </ol>
			</nav>
		</div>
		<hr>
					 ...
					 <tbody>
					 	...
					 	<tr>
					 		...
					 		<td>
					 			...
					 			<input type="file" name="datafile" id="datafile" class="form-control" accept=".gif, .jpg, .png, .hwp, .doc, .txt, .zip, .ppt, .pptx, ">
					 		</td>
					 	</tr>
					 </tbody>
				</table>
